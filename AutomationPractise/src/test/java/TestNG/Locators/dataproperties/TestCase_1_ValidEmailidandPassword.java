...
public class TestCase_1_ValidEmailidandPassword {
	...
	public void ValidEmailandPassword() throws InterruptedException {
		...
		String Actual = driver.findElement(By.xpath(prop.getProperty("Homepage"))).getText();
		System.out.println(driver.findElement(By.xpath(prop.getProperty("Homepage"))).getText());
